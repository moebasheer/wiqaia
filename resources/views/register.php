        ...
        <div class="login-box">
            <div class="login-box-body">
                <div class="login-logo text-center">
                    <a href="#"><img src="assets/images/logo.png" width="70"></a>
                </div>
                <br>
                <p class="login-box-msg text-center">تسجيل عضوية جديدة </p>
                <form class="form-horizontal" method="POST" action="http://wiqaia.org/wiqaia/public/api/reg">
                ...
                <a href="login.php" class="text-center">
                  لديك حساب بالفعل؟ <span style="color: #eb177b"> تسجيل الدخول</span>  
                </a>
