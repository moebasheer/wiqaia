@extends('auth') @section('title',  'تسجيل الدخول') @section('content')
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12 offset-md-4">
                                ...
                                <button type="submit" class="btn btn-primary">
                                     <a href="https://wiqaia.org/public/admin/register" style="color:#fff;"> تسجيل حساب جديد </a>
                                </button>
                            </div>
                        </div>
                    </form>
